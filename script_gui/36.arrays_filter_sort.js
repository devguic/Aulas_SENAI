// Ordenar arrays em um objeto - Ordem Alfabética / Crescente e Decrescente

let nomes = ["Ziraldo", "Joao", "Jonas", "Maria", "Geralda", "Aline"];
...
let usuarios = [
    ...
    {nome: "Rogerio Matias", idade: 31, email: "roger@hotmail.com"}
];
...
//let ordem_decres = numeros.reverse();
let ordem_decres = numeros.sort((x,y) => y - x);
console.log(ordem_decres);
